...
!function (e, t) {
  ...
  var p = function (n) {
    ...
    function _e(a, e, t) {
      ...
      return e.first ? function (e, t, n) {
        ...
        if (n) {
          ...
          if (1 === e.nodeType || f) if (r = (o = e[C] || (e[C] = {}))[e.uniqueID] || (o[e.uniqueID] = {}), u && u === e.nodeName.toLowerCase()) e = e[l] || e;else {
    ...
    function Te(d, p, g, m, v, e) {
      return m && !m[C] && (m = Te(m)), v && !v[C] && (v = Te(v, e)), ue(function (e, t, n, i) {
        ...
        if (g && g(f, h, n, i), m) for (r = Ee(h, l), m(r, [], n, i), o = r.length; o--;) {
          (s = r[o]) && (h[l[o]] = !(f[l[o]] = s));
        }
        ...
        if (e) {
          if (v || d) {
            ...
            for (o = h.length; o--;) {
              (s = h[o]) && -1 < (r = v ? H(e, s) : a[o]) && (e[r] = !(t[r] = s));
            }
          }
    ...
    function xe(e) {
      for (var r, t, n, i = e.length, o = _.relative[e[0].type], s = o || _.relative[" "], a = o ? 1 : 0, l = _e(function (e) {
        ...
        if (t = _.relative[e[a].type]) c = [_e(we(c), t)];else {
    ...
    return ye.prototype = _.filters = _.pseudos, _.setFilters = new ye(), p = ae.tokenize = function (e, t) {
      ...
      if (!s) {
        ...
        (s = A(e, (m = o, y = 0 < (v = r).length, b = 0 < m.length, i = function i(e, t, n, _i2, r) {
          var o,
              s,
              a,
              l = 0,
          ...
          if (l += u, y && u !== l) {
            ...
            if (e) {
              if (0 < l) for (; u--;) {
                c[u] || f[u] || (f[u] = k.call(_i2));
              }
              f = Ee(f);
            }

            L.apply(_i2, f), r && !e && 0 < f.length && 1 < l + v.length && ae.uniqueSort(_i2);
          }
  ...
  (C.fn.init = function (e, t, n) {
    ...
    if (i[1]) {
      if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : x, !0)), N.test(i[1]) && C.isPlainObject(t)) for (i in t) {
            ...
            return function () {
              var n = this,
                ...
                if (!(r < l)) {
                  ...
                  t = e && ("object" == _typeof(e) || "function" == typeof e) && e.then, y(t) ? a ? t.call(e, u(l, o, R, a), u(l, o, q, a)) : (l++, t.call(e, u(l, o, R, a), u(l, o, q, a), u(l, o, R, o.notifyWith))) : (s !== R && (n = void 0, i = [e]), (a || o.resolveWith)(n, i));
                }
              },
                  t = a ? e : function () {
                try {
  ...
  function we(e, t, n, i, r) {
    for (var o, s, a, l, u, c, f = t.createDocumentFragment(), h = [], d = 0, p = e.length; d < p; d++) {
      if ((o = e[d]) || 0 === o) if ("object" === w(o)) C.merge(h, o.nodeType ? [o] : o);else if (_e.test(o)) {
    ...
    for (f.textContent = "", d = 0; o = h[d++];) {
      if (i && -1 < C.inArray(o, i)) r && r.push(o);else if (u = oe(o), s = me(f.appendChild(o), "script"), u && ve(s), n) for (c = 0; o = s[c++];) {
  ...
  C.event = {
    ...
    add: function add(t, e, n, i, r) {
      ...
      if (m) for (n.handler && (n = (o = n).handler, r = o.selector), r && C.find.matchesSelector(re, r), n.guid || (n.guid = C.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
        ...
        d = g = (a = xe.exec(e[u]) || [])[1], p = (a[2] || "").split(".").sort(), d && (f = C.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, f = C.event.special[d] || {}, c = C.extend({
          type: d,
          origType: g,
          data: i,
          handler: n,
  ...
  function Re(e, t) {
    ...
    if (1 === t.nodeType) {
      if (X.hasData(e) && (o = X.access(e), s = X.set(t, o), u = o.events)) for (r in delete s.handle, s.events = {}, u) {
  ...
  function qe(n, i, r, o) {
    ...
    if (f && (t = (e = we(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
      for (a = (s = C.map(me(e, "script"), He)).length; c < f; c++) {
        l = e, c !== h && (l = C.clone(l, !0, !0), a && C.merge(s, me(l, "script"))), r.call(n[c], l, c);
      }

      if (a) for (u = s[s.length - 1].ownerDocument, C.map(s, Pe), c = 0; c < a; c++) {
  ...
  C.extend({
    ...
    clone: function clone(e, t, n) {
      var i,
          ...
          c = e.cloneNode(!0),
          f = oe(e);
      if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e))) for (s = me(c), i = 0, r = (o = me(e)).length; i < r; i++) {
        a = o[i], l = s[i], void 0, "input" === (u = l.nodeName.toLowerCase()) && he.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
      }
      if (t) if (n) for (o = o || me(e), s = s || me(c), i = 0, r = o.length; i < r; i++) {
        Re(o[i], s[i]);
      } else Re(e, c);
  ...
  C.extend({
    ...
    style: function style(e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        "string" === (o = _typeof(n)) && (r = ne.exec(n)) && r[1] && (n = ue(e, t, r), o = "number"), null != n && n == n && ("number" !== o || l || (n += r && r[3] || (C.cssNumber[a] ? "" : "px")), v.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? u.setProperty(t, n) : u[t] = n));
      }
    },
  ...
  function dt(o, e, t) {
    ...
    for (!function (e, t) {
      ...
      for (n in e) {
        if (r = t[i = K(n)], o = e[n], Array.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (s = C.cssHooks[i]) && ("expand" in s)) for (n in o = s.expand(o), delete e[i], o) {
          (n in e) || (e[n] = o[n], t[n] = r);
        } else t[i] = r;
      }
    }(c, u.opts.specialEasing); i < r; i++) {
      if (n = dt.prefilters[i].call(u, o, c, u.opts)) return y(n.stop) && (C._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)), n;
    }
  ...
  C.fn.extend({
    ...
    toggleClass: function toggleClass(r, t) {
      ...
      return "boolean" == typeof t && s ? t ? this.addClass(r) : this.removeClass(r) : y(r) ? this.each(function (e) {
        ...
        var e, t, n, i;
        if (s) for (t = 0, n = C(this), i = _t(r); e = i[t++];) {
  ...
  C.extend(C.event, {
    trigger: function trigger(e, t, n, i) {
      ...
      if (o = f = s = n = n || x, 3 !== n.nodeType && 8 !== n.nodeType && !Et.test(d + C.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(), p.sort()), l = d.indexOf(":") < 0 && "on" + d, (e = e[C.expando] ? e : new C.Event(d, "object" == _typeof(e) && e)).isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), c = C.event.special[d] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
        if (!i && !c.noBubble && !b(n)) {
          for (a = c.delegateType || d, Et.test(a + d) || (o = o.parentNode); o; o = o.parentNode) {
            h.push(o), s = o;
          }
        ...
        for (r = 0; (o = h[r++]) && !e.isPropagationStopped();) {
          f = o, e.type = 1 < r ? a : c.bindType || d, (u = (X.get(o, "events") || {})[e.type] && X.get(o, "handle")) && u.apply(o, t), (u = l && o[l]) && u.apply && V(o) && (e.result = u.apply(o, t), !1 === e.result && e.preventDefault());
        }
  ...
  function kt(n, e, i, r) {
    ...
    if (Array.isArray(e)) C.each(e, function (e, t) {
      i || At.test(n) ? r(n, t) : kt(n + "[" + ("object" == _typeof(t) && null != t ? e : "") + "]", t, i, r);
    ...
    ajax: function ajax(e, t) {
      ...
      var c,
        ...
        statusCode: function statusCode(e) {
          var t;
          if (e) if (p) E.always(e[E.status]);else for (t in e) {
            w[t] = [w[t], e[t]];
          }
          return this;
        },
  ...
  C.ajaxSetup({
    ...
    var i,
        ...
        s = this,
        a = e.indexOf(" ");
    return -1 < a && (i = yt(e.slice(a)), e = e.slice(0, a)), y(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (r = "POST"), 0 < s.length && C.ajax({
      url: e,
      type: r || "GET",
      dataType: "html",
      data: t
  ...
  "object" == ( false ? undefined : _typeof(exports)) && "undefined" != typeof module ? t(exports, __WEBPACK_LOCAL_MODULE_0__) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __WEBPACK_LOCAL_MODULE_0__], __WEBPACK_AMD_DEFINE_FACTORY__ = (t),
  ...
  var le = "collapse",
    ...
    return e.toggle = function () {
      ...
      return this.each(function () {
        var e = p(this),
            t = e.data(ue),
            n = l({}, he, e.data(), "object" == _typeof(i) && i ? i : {});
        ...
        fn: function fn(e, t) {
          ...
          var s,
            ...
            position: r.position
              ...
              x = (s = e, a = window.devicePixelRatio < 2 || !ft, l = s.offsets, u = l.popper, c = l.reference, f = Math.round, h = Math.floor, d = function d(e) {
            return e;
  ...
  var Et = "dropdown",
    ...
    return e.toggle = function () {
      ...
      return this.each(function () {
        ...
        if (e || (e = new u(this, "object" == _typeof(t) ? t : null), p(this).data(Tt, e)), "string" == typeof t) {
  ...
  var En = "tooltip",
    ...
    return e.enable = function () {
      ...
      "object" != _typeof(t) || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = wn(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t)) : e.text(t) : this.config.html ? p(t).parent().is(e) || e.empty().append(t) : e.text(p(t).text());
    }, e.getTitle = function () {
  ...
  var ri = "scrollspy",
    ...
    return e.refresh = function () {
      ...
      return this.each(function () {
        ...
        if (e || (e = new n(this, "object" == _typeof(t) && t), p(this).data(oi, e)), "string" == typeof t) {
          if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
          e[t]();
        }
      });
  ...
  var Fi = "toast",
    ...
    return e.show = function () {
      ...
      return e = l({}, Gi, p(this._element).data(), "object" == _typeof(e) && e ? e : {}), g.typeCheckConfig(Fi, e, this.constructor.DefaultType), e;
    }, e._setListeners = function () {
      var e = this;
      ...
      return this.each(function () {
        ...
        if (t || (t = new i(this, "object" == _typeof(n) && n), e.data(Bi, t)), "string" == typeof n) {
          if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
          t[n](this);
        }
      });
  ...
  "object" == ( false ? undefined : _typeof(exports)) && "undefined" != typeof module ? module.exports = t(__WEBPACK_LOCAL_MODULE_0__) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__WEBPACK_LOCAL_MODULE_0__], __WEBPACK_AMD_DEFINE_FACTORY__ = (t),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : undefined;
}(this, function (e) {
  ...
  return n = "." + (s = t = "metisMenu"), i = (a = e).fn[t], l = {
    ...
    return e.init = function () {
      ...
      return this.each(function () {
        var e = a(this),
            t = e.data(s),
            n = o({}, l, e.data(), "object" == _typeof(i) && i ? i : {});
      ...
      if (u.registerEvent(t), "touchstart" === t.type && d.delay) {
        var i = !1,
          ...
          r && (clearTimeout(r), r = null, d.show(t, n)), i || (i = !0, d.hide(e, n)), s();
            ...
            e = function e(_e2) {
          r && (clearTimeout(r), r = null), o(_e2), s();
        };
      ...
      d.waypoint(function (e) {
        !function () {
          ...
          for (var l = t; l >= p.beginAt / n * t; l--) {
            ...
            if (i) for (; /(\d+)(\d{3})/.test(u.toString());) {
...
/***/ 4:
/*!*************************************************!*\
  !*** multi ./resources/assets/js/vendor.min.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/kelechiokwuriki/Desktop/Dev/Foodie/resources/assets/js/vendor.min.js */"./resources/assets/js/vendor.min.js");
